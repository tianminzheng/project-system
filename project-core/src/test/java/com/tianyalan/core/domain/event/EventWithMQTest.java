...
import com.tianyalan.core.domain.model.project.ProjectCreated;
import com.tianyalan.core.port.adapter.messaging.RabbitMQProjectCreatedSender;
...
public abstract class EventWithMQTest extends EventStoreCommonTest {
	...
	@Autowired
	private RabbitMQProjectCreatedSender rabbitMQProjectCreatedSender;
    ...
    protected void setUp() throws Exception {
		...
		DomainEventPublisher.instance().subscribe(new DomainEventSubscriber<DomainEvent>() {
            ...
            public void handleEvent(DomainEvent aDomainEvent) {
                ...
                if(aDomainEvent.getClass() == ProjectCreated.class) {
                    rabbitMQProjectCreatedSender.pushToMessageQueue(eventSerialization);
                }
            }
