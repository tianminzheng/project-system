...
public class RegisterUserCommand {
	...
	public RegisterUserCommand(String invitationIdentifier, String username, String password, String firstName,
			String lastName, boolean enabled, Date startDate, Date endDate, String emailAddress,
